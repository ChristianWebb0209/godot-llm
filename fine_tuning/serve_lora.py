#!/usr/bin/env python3
"""
OpenAI-compatible LoRA inference server for Vast.ai.

Single-script workflow:
- checks/installs required Python deps
- ensures base model exists locally under /workspace/models/...
- validates adapter files under /workspace/adapter
- starts OpenAI-compatible server

Run:
  python /workspace/godot-llm/fine_tuning/serve_lora.py
"""
...
BASE_MODEL_LOCAL_DIR = os.getenv("BASE_MODEL_LOCAL_DIR", "/workspace/models/Qwen2.5-Coder-7B-Instruct")
