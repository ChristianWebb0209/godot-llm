...
- `fine_tuning/scripts/validate_composer_v3_dataset.py`
...
- `fine_tuning/scripts/generate_composer_v3_adversarial_negatives.py`
...
- `fine_tuning/scripts/rebuild_composer_v3_agent_dataset.py`
- `fine_tuning/scripts/rebuild_composer_v3_ask_dataset.py`
...
- `fine_tuning/scripts/build_composer_v3_dataset_mix.py`
...
- `fine_tuning/scripts/audit_composer_v3_dataset.py`
...
- `fine_tuning/scripts/run_composer_v3_pretrain_gates.py`
...
- `fine_tuning/scripts/run_composer_v3_posttrain_release_gate.py`
...
1. Rebuild strict datasets:
   - `python fine_tuning/scripts/rebuild_composer_v3_agent_dataset.py`
   - `python fine_tuning/scripts/rebuild_composer_v3_ask_dataset.py`
2. Build train/val mix:
   - `python fine_tuning/scripts/build_composer_v3_dataset_mix.py`
3. Run pre-train gates:
   - `python fine_tuning/scripts/run_composer_v3_pretrain_gates.py`
4. Train v3 adapter.
5. Run post-train release gate:
   - `python fine_tuning/scripts/run_composer_v3_posttrain_release_gate.py`
