...
def run_judge_one(question: str, answer_a: str, answer_b: str, name_a: str, name_b: str) -> Optional[str]:
    """Call OpenAI to get A/B/TIE verdict. Returns None if not configured."""
    try:
...
def main() -> None:
    ...
    for pid in prompt_ids:
        ...
        if args.openai:
            verdict_text = run_judge_one(question, ans_rag, ans_composer, "RAG (GPT-4.1-mini)", "Godot Composer")
            if verdict_text:
